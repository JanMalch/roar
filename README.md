...
Download the standalone binary from the latest [v0.7.0 release page](https://github.com/JanMalch/roar/releases/tag/v0.7.0) and just run it. No installation required.
