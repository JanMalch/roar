...
Download the standalone binary from the latest [v0.7.1 release page](https://github.com/JanMalch/roar/releases/tag/v0.7.1) and just run it. No installation required.
